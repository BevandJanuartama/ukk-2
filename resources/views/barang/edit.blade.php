...
<head>
    ...
    <title>Edit Barang - Inventory App</title>
...
<body class="bg-gray-100 flex items-center justify-center min-h-screen p-4">
    ...
    <div class="max-w-2xl w-full bg-white p-8 rounded-xl shadow-lg">
        ...
        <div class="mb-8 border-b pb-4 text-center">
            <h2 class="text-2xl font-bold text-indigo-900 uppercase tracking-wide">Form Edit Barang</h2>
            <p class="text-sm text-gray-500">Perbarui informasi detail barang di bawah ini.</p>
        </div>
